...
constexpr Enum Enum_MIN = ZERO;
constexpr Enum Enum_MAX = THREE;
...
template <> struct is_proto_enum< ::test::pb::Enum> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::test::pb::Enum>() {
  return ::test::pb::Enum_descriptor();
}
